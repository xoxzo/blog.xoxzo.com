Title: 【Xoxzo】Release of Conference API
...
The number of attendees are limited to two people.
...
there will be the same cost as using [VOICE API](http://docs.xoxzo.com/en/voice.html).
...
__follow us [here](https://twitter.com/xoxzotelephony). __
