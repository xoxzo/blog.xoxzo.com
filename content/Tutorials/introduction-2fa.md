...
いろいろなWebサービスで、ユーザIDとパスワード盗み取られ、アカウントが乗っ取られて不正に利用されるという問題が多発しています。
...
Webサービスで、二要素認証を導入するとすれば、その流れは、おおよそ次のようになるでしょう。
...
[^1]:Pyhton3系の利用を想定しています。Python2系には *secrets* パッケージがないので、
