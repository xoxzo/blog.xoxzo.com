...
EZSMSのヘルプデスクも、英語・日本語の両言語に対応しています。困った時、「もっとこんな機能がほしい」と思った時。お好きな言語で、お問い合わせください。
予約送信
「スグ」届く、SMSーだからこそ、送信のタイミングは、気をつけたいですよね。EZSMS・v3なら、「予約送信」ができます。送信準備作業が夜中になってしまっても、送信を翌日の昼間にセットしておけば大丈夫！
詳しい使い方は、こちらをご参照ください。
よりお客様に寄り添った送信管理画面
ウェブから配信も、CSVファイルをアップロードして行う、大量配信やカスタマイズ配信も、これまでと同様にご利用いただけます。ただし、UX・UIのアップグレードは行われましたので、見た目、使いやすさが格段にアップ！
サブアカウント送信
全く新しい機能が追加されました。SMS送信を、担当者ごとに別アカウントに分けて行うことができます。
使いすぎ防止に、サブアカウントごとの利用上限を設定したり、Kプレミアムサービスをご利用の場合、登録した送信元IDを振り分けたり、サブアカウントごとのご利用状況を把握することができます。
個別契約を前提とした一部の企業ユーザー様向けの機能ですので、ご利用ご希望のユーザー様はヘルプデスクまで、アカウントにご登録のメールアドレスを添えて、ご連絡ください。
なお、この機能の追加にともない、「ご利用規約」にも追加変更がございましたので、こちらより、ご確認ください。
開発者向け機能
EZSMS・v3のリリースに先駆け、本年7月をもって、APIのご提供を終了させていただいております。（ブログアナウンスメントへのリンク？）
...
開発者さまにおかれましては、Xoxzo - クラウド・テレフォニー・プラットフォームをご利用いただけますよう、よろしくお願いします。
